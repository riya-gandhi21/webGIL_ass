...
export class Object3DEditor extends BaseNode {
  ...
  _initTags() {
    this.nameInput = new StringInput(this.object3d.name)
      .setReadOnly(true)
  ...
  _initTransform() {
    ...
    const rotX = new NumberInput()
      .setTagColor("red")
      .setStep(rotationStep)
      .onChange(update);
    const rotY = new NumberInput()
      .setTagColor("green")
      .setStep(rotationStep)
      .onChange(update);
    const rotZ = new NumberInput()
      .setTagColor("blue")
      .setStep(rotationStep)
      .onChange(update);

    const scaleX = new NumberInput(100)
      .setTagColor("red")
      .setStep(rotationStep)
      .onChange(update);
    const scaleY = new NumberInput(100)
      .setTagColor("green")
      .setStep(rotationStep)
      .onChange(update);
    const scaleZ = new NumberInput(100)
      .setTagColor("blue")
      .setStep(rotationStep)
      .onChange(update);
