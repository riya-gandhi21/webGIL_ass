      ...
      if (material.isMeshPhysicalNodeMaterial) {
        if (material.clearcoatNode && material.clearcoatNode.isNode) {
          ...
          if (
            ...
            material.clearcoatRoughnessNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
          ...
          if (
            ...
            material.clearcoatNormalNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
        ...
        if (material.sheenNode && material.sheenNode.isNode) {
          ...
          if (
            material.sheenRoughnessNode &&
            material.sheenRoughnessNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
        ...
        if (material.iridescenceNode && material.iridescenceNode.isNode) {
          ...
          if (
            material.iridescenceIORNode &&
            material.iridescenceIORNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
          ...
          if (
            material.iridescenceThicknessNode &&
            material.iridescenceThicknessNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
        ...
        if (
          ...
          material.specularIntensityNode.isNode
        ) {
          this.addSlot(
            "fragment",
            new SlotNode({
        ...
        if (material.transmissionNode && material.transmissionNode.isNode) {
          ...
          if (
            ...
            material.attenuationDistanceNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
          ...
          if (
            ...
            material.attenuationColorNode.isNode
          ) {
            this.addSlot(
              "fragment",
              new SlotNode({
...
`;
  ...
  _parseInclude(shaderStage, ...includes) {
    for (const name of includes) {
      ...
      this.shader[shaderProperty] = this.shader[shaderProperty].replaceAll(
        includeSnippet,
        code
      );
    }
  ...
  _sortSlotsToFlow() {
    for (const shaderStage of defaultShaderStages) {
      ...
      const slots = this.slots[shaderStage].sort((slotA, slotB) => {
        ...
        return sourceCode.indexOf(slotA.source) >
          sourceCode.indexOf(slotB.source)
          ? 1
          : -1;
      });
