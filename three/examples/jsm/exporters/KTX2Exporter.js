...
const ERROR_FORMAT =
  "THREE.KTX2Exporter: Supported formats are RGBAFormat, RGFormat, or RedFormat.";
const ERROR_TYPE =
  'THREE.KTX2Exporter: Supported types are FloatType, HalfFloatType, or UnsignedByteType."';
const ERROR_ENCODING =
  "THREE.KTX2Exporter: Supported encodings are sRGB (UnsignedByteType only) or Linear.";
...
export class KTX2Exporter {
  parse(arg1, arg2) {
    ...
    if (
      VK_FORMAT_MAP[texture.format][texture.type][texture.encoding] ===
      undefined
    ) {
